...
#define EXT0_PID_PGAIN_OR_DEAD_TIME   2.8
...
/** P-gain.  Overridden if EEPROM activated. */
#define EXT1_PID_PGAIN_OR_DEAD_TIME   2.8
/** I-gain.  Overridden if EEPROM activated.
*/
...
#define EXT2_PID_PGAIN_OR_DEAD_TIME 19.56
...
/** P-gain.  Overridden if EEPROM activated. */
#define HEATED_BED_PID_PGAIN_OR_DEAD_TIME   4.2
/** I-gain  Overridden if EEPROM activated.*/
